...
void mostrarCreditos()
{
    ...
    system("cls");
    cout << "\033[40;33m------------ Trabajo practico integrador ------------" << endl;
    cout << endl;
    cout << "--------------------- Equipo 4 ---------------------" << endl;
    cout << endl;
...
int salirJuego()
{
    system("cls");
    char opcionSalir;
    cout << "\033[40;31m¿Esta seguro que desea salir del juego? (S/N): \033[0m\n" << endl;
    cin >> opcionSalir;
    cout << endl;
    while (opcionSalir != 'S' && opcionSalir != 's' && opcionSalir != 'N' && opcionSalir != 'n')
    {
        cout << "\033[40;31mPor favor, ingrese S para salir o N para cancelar su eleccion: \033[0m\n" << endl;
        cin >> opcionSalir;
        cout << endl;
    }
