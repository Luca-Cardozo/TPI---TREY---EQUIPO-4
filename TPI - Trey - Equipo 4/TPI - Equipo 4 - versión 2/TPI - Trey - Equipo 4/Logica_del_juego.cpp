...
void robarCarta(string nombre1, string nombre2, int &carta1, int &carta2)
{
    ...
    {
        cout << "\033[40;31mEl numero ingresado debe ser mayor o igual a 1 y menor o igual a 20. Intentelo nuevamente: \033[0m\n";
        cin >> opcion1;
        cout << endl;
    }
    ...
    {
        cout << "\033[40;31mEl numero ingresado debe ser mayor o igual a 1 y menor o igual a 20, y no puede ser " << opcion1 << " porque ya fue elegido. Intentelo nuevamente: \033[0m\n";
        cin >> opcion2;
        cout << endl;
    }
...
void dosDados(int dado1, int dado2, int &PTJugador, int &contadorBugs, int &puntosAcumuladosTotales, int &puntosAcumuladosTurno, bool &bugsTurno, bool &seguir)
{
    ...
    if (bugCount == 2)
    {
        ...
        {
            cout << endl;
            cout << "\033[40;31m¡Como tienes 6 o mas bugs y salieron 2 mas, pierdes 10 puntos!\033[0m\n";
            cout << endl;
    ...
    else if (bugCount == 1)
    {
        ...
        {
            cout << endl;
            cout << "\033[40;31m¡Como tienes 6 o mas bugs y salio 1 mas, pierdes 5 puntos!\033[0m\n";
            cout << endl;
            puntosAcumuladosTotales -= 10;
            if (puntosAcumuladosTotales < 0)
            {
        ...
        {
            cout << endl;
            cout << "\033[40;33m¡Obtuviste 1 bug y 1 fix (se anulan entre ellos)!¡No sumas puntos en esta ronda y se termina el turno!\033[0m\n" << endl;
            cout << endl;
        }
        else
        {
            cout << endl;
            cout << "\033[40;33m¡Salio 1 Bug! Perdés los puntos acumulados y se termina el turno.\033[0m\n";
            cout << endl;
            contadorBugs++;
        }
        puntosAcumuladosTurno = 0;
    ...
    else if (fixCount == 1)
    {
        contadorBugs--;
        cout << endl;
        cout << "\033[40;36m¡Salio 1 Fix! Se resta 1 Bug.\033[0m\n";
        cout << endl;
    }
    else if (fixCount == 2)
    {
        ...
        PTJugador += 1;
        cout << endl;
        cout << "\033[40;36m¡Salieron 2 Fixes! Se restan 2 Bugs y sumas 1 PT.\033[0m\n";
        cout << endl;
    }
    if (contadorBugs < 0)
    {
...
void tresDados(int dado1, int dado2, int dado3, int &PTJugador, int &contadorBugs, int &puntosAcumuladosTotales, int &puntosAcumuladosTurno, bool &bugsTurno, bool &seguir)
{
    ...
    case 3:
        ...
        {
            cout << endl;
            cout << "\033[40;31m¡Como tienes 6 o mas bugs y salieron 3 mas, pierdes 15 puntos!\033[0m\n";
            cout << endl;
    ...
    case 3:
        ...
        PTJugador += 2;
        cout << endl;
        cout << "\033[40;36m¡Salieron 3 Fixes! Se restan 3 Bugs y sumas 2 PTs.\033[0m\n";
        cout << endl;
        break;
    case 2:
        contadorBugs -= 2;
